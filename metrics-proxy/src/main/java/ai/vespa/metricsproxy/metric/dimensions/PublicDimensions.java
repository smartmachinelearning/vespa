...
public final class PublicDimensions {
    ...
    private static final String API = "api";                      // feed
    private static final String CHAIN = "chain";                  // query
    private static final String DOCUMENT_TYPE = "documenttype";   // content
    private static final String ENDPOINT = "endpoint";            // query
    private static final String GC_NAME = "gcName";               // container
    private static final String HTTP_METHOD = "httpMethod";       // container
    private static final String OPERATION = "operation";          // feed
    private static final String RANK_PROFILE = "rankProfile";     // content
    private static final String REASON = "reason";                // query (degraded etc.)
    private static final String STATUS = "status";                // feed
